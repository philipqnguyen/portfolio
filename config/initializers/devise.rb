...
Devise.setup do |config|
  ...
  # config.secret_key = 'a469b409c848701a55ce790a9f45041bb35bd5579e01891b04d982
  # 8fa059178e30a0e8682789ccf84ee1d2413a4f991a43cb61d65202be6a61a3be74764a4db2'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'admin@philip-q-nguyen.com'
  ...
  # session. If you need permissions, implement that in before filter.
  ...
  # config.pepper = '29766276bc5436abb4811e0afbaa951a20feeed602a0d8382f14d9062b
  # 20b30d7d6bf7d2dd748977bb37f622c56e5d7a0da3c9f5ef095a1aa3657a9d74cff03c'
